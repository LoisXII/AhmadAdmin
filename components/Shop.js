        ...
        <form onSubmit={createProduct} className='addWebsiteform'>
            ...
            <div className='w-100 flex flex-col flex-left mb-2' data-aos="fade-up">
                ...
                <select onChange={(e) => setTags(Array.from(e.target.selectedOptions, option => option.value))} name="tags" id="tags" multiple value={tags}>
                    <option value="ADAPTER">Protein Powders</option>
                    <option value="USB C">Vitamins & Supplements</option>
                    <option value="GRAPHIC">Organic Snacks</option>
                    <option value="GIMBAL">Superfoods</option>
                    <option value="CONTENT CREATORS">Meal Replacements</option>
                    <option value="DESK">Hydration</option>
                    <option value="STANDING DESK">Herbal Products</option>
                </select>
